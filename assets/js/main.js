    ...
    update: [
      {
        read: function (ref) {
          ...
          var padding =
            this.parallax && getPaddingBottom(this.parallax, rows, translates);
          return {
            padding: padding,
            rows: rows,
  ...
  var Slideshow = {
    ...
    computed: {
      animation: function (ref) {
        ...
        return assign(
          animation in Animations ? Animations[animation] : Animations.slide,
          {
            name: animation,
          }
        );
