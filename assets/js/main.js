(function(global, factory) {
    ...
    var IntersectionObserver = inBrowser && window.IntersectionObserver || function() {
    ...
    var slider = {
        ...
        computed: {
            ...
            maxIndex: function() {
                ...
                return this.length - findIndex(this.slides.slice().reverse(), function(el) {
...
(function(global, factory) {
    ...
    function plugin(UIkit) {
        ...
        UIkit.icon.add({
            ...
            medium: '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.19998 16.6312C7.19998 16.9875 7.00935 17.2 6.73904 17.2C6.64373 17.2 6.53748 17.1734 6.42498 17.1172L2.0656 14.9094C1.80935 14.7797 1.59998 14.4359 1.59998 14.1469V3.32499C1.59998 3.03905 1.75154 2.8703 1.96873 2.8703C2.04529 2.8703 2.13123 2.89061 2.22029 2.93593L2.37341 3.01405H2.37498L7.17966 5.44686C7.18748 5.45155 7.19373 5.45936 7.19998 5.46561V16.6312ZM12.2343 3.55311L12.5281 3.0703C12.6328 2.89843 12.825 2.79999 13.0203 2.79999C13.0656 2.79999 13.1125 2.80624 13.1578 2.81874C13.1922 2.82655 13.2281 2.83905 13.2656 2.8578L18.3328 5.42343C18.3343 5.42343 18.3343 5.42499 18.3343 5.42499L18.339 5.42655C18.3422 5.42811 18.3422 5.4328 18.3453 5.43436C18.3703 5.45468 18.3812 5.48905 18.364 5.51718L13.3172 13.8234L12.8015 14.6703L9.45779 8.12186L12.2343 3.55311ZM7.99998 12.2422V7.02499L11.5922 14.0625L8.36091 12.4266L7.99998 12.2422ZM18.4 16.6312C18.4 16.9656 18.2015 17.1562 17.9093 17.1562C17.7781 17.1562 17.6281 17.1187 17.4703 17.0391L16.7468 16.6719L13.5156 15.0359L18.4 6.99843V16.6312Z"/></svg>',
...
window.onload = function() {
    ...
    for (var j = 0; j < linksDocs.length; j++) {
        linksDocs[j].addEventListener("mouseover", linkDocsHover, false);
        linksDocs[j].addEventListener("mouseout", linkDocsOut, false);
    }
};